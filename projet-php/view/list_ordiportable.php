...
<div class="top">
        ...
        <div class="row-fluid">
            ...
            <ul class="loginbar">
			 <?php 
				...
				<button  class="btn btn btn-primary" data-toggle="modal" data-target="#test" >mon compte</button>
				<?php }else {?>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
			 ...
			 <?php  
			   ...
			   { ?>
                <li><a href="../controler/informatique.php?idss=<?php echo $rows['id_ssCateg'] ?>"> <?php echo $rows['libelle_ssCateg'] ?> </a></li>
			  <?php } ?>
            </li>
			</ul>
	...
	<?php
	   ...
	   <div class="modal-footer">
		...
		<?php if(isset($_SESSION['login'])){ echo  "<a href='../controler/commande.php?commander' class='btn btn-danger' >passer la commande</a>";}?>
       </div>	   
	</div>
	</div>
     </div>
    ...
    <div class="highlightSection">
		<div class="container">
			...
			<h4>E-waxalé
			est devellopper par ibrahima ndiaye programmeur en classe de licence LPGL et est l'un des leadeur dans le domaine de e-commerce au senegel</h4>
	...
	<table align="center"  width="250%" cellpadding="6" cellspacing="6" border="6" bordercolor="#FFFFFF">
	 <tr>
		...
		<div class="modal fade" id="commande<?php echo $row['idProd']; ?>" role="dialog" >
		   ...
		   <p align="right"><img src="assets/custom/img/<?php echo $imageName ;?>"width="20%"height="40" /></p>
		    <p> <form class="form-horizontal" role="form" action="list_ordiportable.php" method="get">
	 ...
	 <div class="modal fade" id="deconnexion" role="dialog"  >
	   ...
	   <div class="modal-body">
	   <p><a href="acceuil.php?deconection"class="btn btn-primary" type="button"  >CONFIRMER</a></p>
	   </div>
	   <div class="modal-footer">
	    <a class="btn btn-primary" data-dismiss="modal">fermer</a>
       </div>	   

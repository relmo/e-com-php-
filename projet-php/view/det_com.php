...
<div class="top">
    ...
    <div class="highlightSection">
		<div class="container">
			...
			<font color="#FF0000"><h4>details sur la commande </h4></font>
				</p>
			</div>
			</div>
		</div>
	</div>
	<p align="center"><a href="../controler/compte.php?listcommande" class="btn btn-primary" >precedent</a></p>
	<table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
    <thead>
    <tr>
        <th>produit</th>
	...
	if(count($listpp)==0)
	{
     ...
     foreach($listpp as  $row)
			 ...
			 ?>
		      <tr>
			  <?php ?>
             <td class="center"><?php echo $row['libelleProd'] ; ?></td>
        <td class="center"><?php echo $row['prix']; ?></td>
        <td class="center">
            <span class="label-success label label-default"><?php echo $row['quantite']; ?></span>
        </td>
		<td class="center"><?php echo $row['montant']; ?></td>
        <td class="center">
            <a class="btn btn-success" href="#?idcm=<?php echo $row['idCde']; ?>">
                <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                modifier
            </a>
            <a class="btn btn-danger" href="#">

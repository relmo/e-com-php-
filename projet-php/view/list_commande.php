...
<div class="top">
	...
	if(count($listcom)==0)
	{
	 echo "<h1> votre liste de commande est vide</h1>";
	}else{
     foreach($listcom as  $row)
			 ...
			 ?>
		      <tr>
             <td class="center"><?php echo $row['dateCde']; ?></td>
        <td class="center"><?php echo $row['montant']; ?></td>
        <td class="center">
            <span class="label-success label label-default"><?php echo $statut; ?></span>
        </td>
		<td class="center"><?php echo $row['adresliv']; ?></td>
		<td class="center"><span class="label-success label label-default"><?php echo  $etat  ?></span></td>
        <td class="center">
            <a class="btn btn-success" href="../controler/compte.php?idcm=<?php echo $row['idCde']; ?>">
                <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                voir detail
            </a>
			...
			<?php if($row['statut']==0) { ?>
			<button class="btn btn-info" class="modal" data-toggle="modal" data-target="#payer<?php echo $row['idCde']; ?>" >
                payer la commande
            </button>
			<?php } ?>
        </td>
    </tr>
	<div class="modal fade" id="confsup<?php echo $row['idCde']; ?>" role="dialog"  >
	     <div class="modal-dialog">
	    <div class="modal-content">
	    <div class="modal-header">
	   <p><h4>VOULEZ VOUS VREMENT supprimer la commande</h4></p>
	   <div class="modal-body">
	   <p><a href="../controler/commande.php?confsup=<?php echo $row['idCde']; ?>"class="btn btn-primary" type="button"  >CONFIRMER</a></p>
	   </div>
	   <div class="modal-footer">

...
<div class="top">
        ...
        <div class="row-fluid">
            ...
            <ul class="loginbar">
			 <?php 
				...
				<a href=""  class="btn btn btn-primary" >mon compte</a>
				<?php }else {?>
	...
	<?php
	   ...
	   <div class="modal-footer">
		...
		<?php if(isset($_SESSION['login'])){ echo  "<button class='btn btn-danger' class='modal' data-toggle='modal' data-target='#commander1' >passer la commande</button>";}else{
...
<div class="modal fade" id="commander1" role="dialog"  >
    ...
    <div class="highlightSection">
		<div class="container">
			...
			<font color="#FF0000"><h4>!!! bienvenue dans votre espace privé</h4></font>
				</p>
			</div>
			</div>
		</div>
	 ...
	 <tr>
		<td width="25"><a href="../controler/compte.php?listcommande"><img src="../controler/assets/custom/img/commande.jpg" width="50%" height="50%" /></a></td>
		<td width="25"><a href="../controler/facture.php?listfacture"><img src="../controler/assets/custom/img/facture.jpg" width="40%" height="40%"  /></a></td>
	     <td width="25"><a href=""><img src="../controler/assets/custom/img/profil.jpg" width="50%" height="50%" /></a></td>
		 <td width="25"><button data-toggle="modal" data-target="#lpn"><img src="../controler/assets/custom/img/pcli.jpg" width="50%" height="50%" /></button></td>
		 </tr>
		  <tr>
		<td width="25"><button class="btn btn-primary" type="button">mes commandes </button></td>
		<td width="25"><button class="btn btn-primary" type="button">mes factures </button></td>
	     <td width="25"><button class="btn btn-primary" type="button"> modifier profil</button></td>
		 <td width="25"><button class="btn btn-primary" type="button">mon panier </button></td>
		 </tr>
		 </table>

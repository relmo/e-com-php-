				...
				<tr>
					...
					?>
						<tr>
							...
							<td><a class="btn btn-warning btn-sm" href="../Controller/produit.php?action=modifier&id=<?php echo $row['idProd'];?>">Modifier</a></td>
							<td><a class="btn btn-danger btn-sm" href="../Controller/produit.php?action=supprimer&id=<?php echo $row['idProd'];?>" onClick="return confirm('Voulez vous variment supprimer cet produit?')">Supprimer</a></td>
							<td><a class="btn btn-success btn-md" href="../Controller/produit.php?action=mouvement&id=<?php echo $row['idProd'];?>">Mouvement</a></td>
						</tr>	
					<?php 	
							} 
						}					
